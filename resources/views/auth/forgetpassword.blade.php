                ...
                <div class="text-center mt-4">
                    <div class="mb-3">
                        <a href="index.html" class="auth-logo">
                            <img src="assets/media/logos/PayMob.png" height="80" class="logo-dark mx-auto" alt="">
                    ...
                    <form class="form-horizontal mt-3" method="post" action="{{route('password.email')}}">
                        ...
                        <div class="form-group mb-0 row mt-2">
                            ...
                            <div class="col-sm-5 mt-3">
                                <a href="{{ route('login') }}" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a>
                            </div>
                        </div>
                    </form>
                </div>
